## Ejemplo Ataque "Billion Laughs" en Python - Flask
...
## Resumen
Aplicación Flask mínima que parsea XML utilizando `lxml` con protecciones desactivadas (`resolve_entities=True`, `no_network=False`, `huge_tree=True`) para ilustrar cómo funciona un ataque de *entity expansion* (Billion Laughs). Propósito: **docente**.
...
- `pip`.  
- En Arch Linux: `base-devel`, `libxml2`, `libxslt`, `python`
